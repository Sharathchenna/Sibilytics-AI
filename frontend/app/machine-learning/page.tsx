            ...
            <div className="relative py-16 md:py-24 overflow-hidden" style={{ backgroundColor: '#F5EFFF' }}>
                ...
                <div className="relative max-w-7xl mx-auto px-6 z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 bg-white/80 border px-4 py-2 rounded-full text-sm font-semibold mb-8 backdrop-blur-sm animate-fade-in" style={{ borderColor: '#E8E0F0', color: '#8B5CF6', fontFamily: 'var(--font-jakarta)' }}>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight animate-fade-in" style={{ fontFamily: 'var(--font-playfair)', color: '#3D342B' }}>
                            SVM-Based <br />
                            <span className="italic" style={{ color: '#8B5CF6' }}>Classification</span>
                        </h1>
